        ...
        {posts && posts.length > 0 ? (
          <div className="flex w-full flex-wrap items-stretch">
            {posts?.map((item, idx) => (
              ...
              >
                <div className="border-border flex h-full flex-col overflow-clip rounded-xl border transition-shadow hover:shadow-md">
                  <div className="flex h-full flex-col px-4 py-4 md:px-4 md:py-4 lg:px-4 lg:py-4">
                    <h3 className="mb-3 line-clamp-2 text-lg font-semibold md:mb-4 md:text-xl">
                      {item.title}
                    </h3>
                    <p className="text-muted-foreground mb-3 line-clamp-4 text-sm md:mb-4">
                      {item.description}
                    </p>
